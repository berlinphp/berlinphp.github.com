---
layout: post-slots
title: Meetup on the 7th of November, 2023
datetitle: November 7th, 2023
published: true
meetupdate: 2023-11-07
---

<div class="slot span4"><div class="icon-awesome"><i class="icon-comment-alt"></i></div>
    <h4>Logging objects using processors</h4>
    <p>Let's create small processors to extract the objects' values that is needed.</p>
    <p><a class="speaker" target="_blank" href="https://blog.erison.work">Erison Silva</a></p>
</div>
